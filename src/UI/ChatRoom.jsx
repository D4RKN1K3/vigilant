...
const ChatRoom = ({ route }) => {
  ...
  useEffect(() => {
    ...
    socketRef.current = io.connect("192.168.71.34:9000"); // Address of the Signal server
  ...
  function handleReceiveMessage(e){
    ...
    //el codigo anterior utiliza gifted chat, sin gifted chat seria
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <TextInput
          ...
          onChangeText={(text) => setMessages([{_id: Math.random(1000).toString(), text: text, createdAt: new Date(), user: {_id: 1}}])}
        />
        <Button
          title="Send"
          onPress={() => sendMessage(messages)}
        />
      </View>
    </View>
  )
